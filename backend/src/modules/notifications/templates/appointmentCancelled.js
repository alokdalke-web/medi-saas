exports.generateAppointmentCancelledTemplate = (data) => {
  const {
    clinicName,
    recipientName,
    appointmentDate,
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Please note that the following appointment has been <strong>cancelled</strong>.</p>
      ...
      <p style="margin-top: 30px;">If this was done in error or you need to reschedule, please contact ${clinicName} at ${clinicPhone}.</p>
    </div>
    <div class="footer">
